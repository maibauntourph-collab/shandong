...
exports.deleteFromVectorDB = exports.searchDocuments = exports.addDocumentToVectorDB = void 0;
...
const addDocumentToVectorDB = async (content, metadata) => {
...
exports.addDocumentToVectorDB = addDocumentToVectorDB;
...
const deleteFromVectorDB = async (ids) => {
    const col = await initChroma();
    if (!col || ids.length === 0) {
        return;
    }
...
exports.deleteFromVectorDB = deleteFromVectorDB;
